...
/* ── SAMPLE DATA ─────────────────────────────────────────────────────── */
const INIT_LEADS=[
  {id:"L001",company:"TechNova Pvt Ltd",contact:"Arjun Shah",phone:"+91 9876543210",backupPhone:"+91 9876543211",email:"arjun@technova.com",backupEmail:"it@technova.com",role:"CTO",location:"Bangalore",source:"Google Ads",campaign:"Q1-Search-2025",adGroup:"Mobile Dev",score:"Hot",status:"Proposal Sent",service:"Mobile App Development",dealValue:320000,budgetConfirmed:true,timelineConfirmed:true,assignedTo:"Priya Nair",assignStatus:"approved",createdDate:"2025-01-15",stageEnteredDate:"2025-02-25",wonDate:null,followUpDate:"2025-03-10",lastContactDate:"2025-02-28",expectedCredit:"2025-03-20",creditChanges:[{date:"2025-02-20",oldDate:"2025-03-10",newDate:"2025-03-20",by:"Priya Nair",reason:"Client requested extension"}],remarks:"Interested in React Native",lostReason:"",disqReason:"",proposalViewed:true,proposalViewedAt:"2025-02-15 10:32 AM",qualChecklist:{budget:true,decisionMaker:true,requirement:true,timeline:true},nps:null,
   notes:[{text:"Client is price-sensitive – offered 10% discount",by:"Priya Nair",date:"2025-02-28",time:"3:00 PM"},{text:"Decision maker is Arjun; CFO approves final budget",by:"Priya Nair",date:"2025-03-01",time:"10:00 AM"}],
   tasks:[{id:"T1",title:"Send revised proposal",assignedTo:"Priya Nair",dueDate:"2025-03-08",status:"Pending"},{id:"T2",title:"Schedule demo call",assignedTo:"Priya Nair",dueDate:"2025-03-10",status:"Completed"}],
   history:[{action:"Lead Created",by:"Admin",date:"2025-01-15",time:"9:00 AM"},{action:"Assigned to Priya Nair",by:"Sales Manager",date:"2025-01-15",time:"9:05 AM"},{action:"Assignment Approved",by:"Priya Nair",date:"2025-01-15",time:"9:30 AM"},{action:"Status → Proposal Sent",by:"Priya Nair",date:"2025-02-10",time:"2:30 PM"},{action:"Proposal viewed by client",by:"System",date:"2025-02-15",time:"10:32 AM"}]},
  {id:"L002",company:"GreenLeaf Organics",contact:"Meena Rajan",phone:"+91 9988776655",backupPhone:"",email:"meena@greenleaf.com",backupEmail:"",role:"CEO",location:"Chennai",source:"Referral",campaign:"—",adGroup:"—",score:"Warm",status:"Negotiation",service:"LMS Product",dealValue:180000,budgetConfirmed:true,timelineConfirmed:false,assignedTo:"Alex Morgan",assignStatus:"approved",createdDate:"2025-02-03",stageEnteredDate:"2025-02-20",wonDate:null,followUpDate:"2025-03-12",lastContactDate:"2025-03-01",expectedCredit:"2025-03-25",creditChanges:[],remarks:"Need custom LMS features",lostReason:"",disqReason:"",proposalViewed:false,proposalViewedAt:null,qualChecklist:{budget:true,decisionMaker:true,requirement:true,timeline:false},nps:null,
   notes:[{text:"Wants white-label, check with tech team",by:"Alex Morgan",date:"2025-03-01",time:"2:00 PM"}],
   tasks:[{id:"T3",title:"Prepare custom LMS quotation",assignedTo:"Alex Morgan",dueDate:"2025-03-10",status:"In Progress"}],
   history:[{action:"Lead Created",by:"Admin",date:"2025-02-03",time:"10:00 AM"},{action:"Assigned to Alex Morgan",by:"Sales Manager",date:"2025-02-03",time:"10:10 AM"},{action:"Assignment Approved",by:"Alex Morgan",date:"2025-02-03",time:"11:00 AM"},{action:"Status → Negotiation",by:"Alex Morgan",date:"2025-02-20",time:"3:00 PM"}]},
  {id:"L003",company:"BlueSky Logistics",contact:"Raj Mehta",phone:"+91 9012345678",backupPhone:"",email:"raj@bluesky.com",backupEmail:"",role:"Director",location:"Mumbai",source:"Meta",campaign:"Meta-Feb-Brand",adGroup:"Awareness",score:"Cold",status:"New",service:"Web Development",dealValue:80000,budgetConfirmed:false,timelineConfirmed:false,assignedTo:"Tom Hank",assignStatus:"pending",createdDate:"2025-02-20",stageEnteredDate:"2025-02-20",wonDate:null,followUpDate:"2025-03-14",lastContactDate:"",expectedCredit:"2025-04-01",creditChanges:[],remarks:"Exploring options",lostReason:"",disqReason:"",proposalViewed:false,proposalViewedAt:null,qualChecklist:{budget:false,decisionMaker:false,requirement:false,timeline:false},nps:null,
   notes:[],tasks:[{id:"T4",title:"Initial discovery call",assignedTo:"Tom Hank",dueDate:"2025-03-06",status:"Overdue"}],
   history:[{action:"Lead Created",by:"Admin",date:"2025-02-20",time:"3:00 PM"},{action:"Assigned to Tom Hank – Pending Approval",by:"Sales Manager",date:"2025-02-20",time:"3:05 PM"}]},
  {id:"L004",company:"Sunrise Hotels",contact:"Kavya Pillai",phone:"+91 8765432109",backupPhone:"+91 8765432108",email:"kavya@sunrise.com",backupEmail:"accounts@sunrise.com",role:"CEO",location:"Mumbai",source:"Expo",campaign:"TravelExpo2025",adGroup:"—",score:"Hot",status:"Won",service:"ERP System",dealValue:450000,budgetConfirmed:true,timelineConfirmed:true,assignedTo:"Sara Lee",assignStatus:"approved",createdDate:"2025-01-08",stageEnteredDate:"2025-02-28",wonDate:"2025-02-28",followUpDate:"—",lastContactDate:"2025-02-28",expectedCredit:"2025-02-28",creditChanges:[{date:"2025-02-01",oldDate:"2025-02-15",newDate:"2025-02-28",by:"Sara Lee",reason:"Client delayed budget approval"},{date:"2025-02-20",oldDate:"2025-02-28",newDate:"2025-02-28",by:"Sara Lee",reason:"Confirmed by CFO"}],remarks:"Closed deal ✓",lostReason:"",disqReason:"",proposalViewed:true,proposalViewedAt:"2025-01-20 2:15 PM",qualChecklist:{budget:true,decisionMaker:true,requirement:true,timeline:true},nps:9,
   notes:[{text:"VIP client, priority support needed post-go-live",by:"Sara Lee",date:"2025-02-28",time:"5:10 PM"}],
   tasks:[{id:"T5",title:"Send welcome onboarding kit",assignedTo:"Sara Lee",dueDate:"2025-03-05",status:"Completed"}],
   history:[{action:"Lead Created",by:"Admin",date:"2025-01-08",time:"9:00 AM"},{action:"Assigned to Sara Lee",by:"Sales Manager",date:"2025-01-08",time:"9:10 AM"},{action:"Assignment Approved",by:"Sara Lee",date:"2025-01-08",time:"9:45 AM"},{action:"Status → Won",by:"Sara Lee",date:"2025-02-28",time:"5:00 PM"},{action:"NPS Score submitted: 9",by:"Kavya Pillai",date:"2025-03-02",time:"10:00 AM"}]},
  {id:"L005",company:"FutureEdu Academy",contact:"Dinesh Kumar",phone:"+91 9543210987",backupPhone:"",email:"dinesh@futureedu.com",backupEmail:"",role:"Principal",location:"Pune",source:"Website",campaign:"—",adGroup:"—",score:"Warm",status:"Qualified",service:"LMS Product",dealValue:150000,budgetConfirmed:false,timelineConfirmed:true,assignedTo:"",assignStatus:"unassigned",createdDate:"2025-02-25",stageEnteredDate:"2025-02-25",wonDate:null,followUpDate:"2025-03-16",lastContactDate:"2025-03-02",expectedCredit:"2025-03-30",creditChanges:[],remarks:"Demo scheduled",lostReason:"",disqReason:"",proposalViewed:false,proposalViewedAt:null,qualChecklist:{budget:false,decisionMaker:true,requirement:true,timeline:true},nps:null,
   notes:[],tasks:[],
   history:[{action:"Lead Created (Website Form)",by:"System",date:"2025-02-25",time:"4:30 PM"}]},
  {id:"L006",company:"Vertex Solutions",contact:"Anita Rao",phone:"+91 9234567890",backupPhone:"",email:"anita@vertex.com",backupEmail:"",role:"Operations Head",location:"Hyderabad",source:"Partner",campaign:"PartnerQ1",adGroup:"B2B",score:"Hot",status:"Closing Soon",service:"Cloud Infrastructure",dealValue:220000,budgetConfirmed:true,timelineConfirmed:true,assignedTo:"Priya Nair",assignStatus:"pending",createdDate:"2025-03-01",stageEnteredDate:"2025-03-01",wonDate:null,followUpDate:"2025-03-10",lastContactDate:"2025-03-01",expectedCredit:"2025-03-28",creditChanges:[{date:"2025-03-03",oldDate:"2025-03-20",newDate:"2025-03-28",by:"Priya Nair",reason:"Client travel schedule"}],remarks:"Partner referred – urgent",lostReason:"",disqReason:"",proposalViewed:true,proposalViewedAt:"2025-03-02 11:40 AM",qualChecklist:{budget:true,decisionMaker:true,requirement:true,timeline:true},nps:null,
   notes:[],tasks:[{id:"T6",title:"Send final agreement",assignedTo:"Priya Nair",dueDate:"2025-03-08",status:"Pending"}],
   history:[{action:"Lead Created",by:"Admin",date:"2025-03-01",time:"10:00 AM"},{action:"Assigned to Priya Nair – Pending Approval",by:"Sales Manager",date:"2025-03-01",time:"10:05 AM"},{action:"Proposal viewed by client",by:"System",date:"2025-03-02",time:"11:40 AM"}]},
  {id:"L007",company:"Quantum Retail",contact:"Suresh Iyer",phone:"+91 9876501234",backupPhone:"",email:"suresh@quantumretail.com",backupEmail:"",role:"IT Head",location:"Bangalore",source:"Google Ads",campaign:"Q1-Search-2025",adGroup:"ERP",score:"Cold",status:"Lost",service:"ERP System",dealValue:300000,budgetConfirmed:false,timelineConfirmed:false,assignedTo:"Alex Morgan",assignStatus:"approved",createdDate:"2025-01-20",stageEnteredDate:"2025-02-10",wonDate:null,followUpDate:"—",lastContactDate:"2025-02-10",expectedCredit:"",creditChanges:[],remarks:"Went with competitor",lostReason:"Price too high",disqReason:"",proposalViewed:true,proposalViewedAt:"2025-02-05 3:00 PM",qualChecklist:{budget:false,decisionMaker:true,requirement:true,timeline:false},nps:null,
   notes:[{text:"Client went with a cheaper SaaS solution – SAP",by:"Alex Morgan",date:"2025-02-10",time:"4:00 PM"}],
   tasks:[],
   history:[{action:"Lead Created",by:"Admin",date:"2025-01-20",time:"9:00 AM"},{action:"Assigned to Alex Morgan",by:"Sales Manager",date:"2025-01-20",time:"9:10 AM"},{action:"Status → Lost",by:"Alex Morgan",date:"2025-02-10",time:"4:00 PM",reason:"Price too high"}]},
];
